...
public class RequetNative {
    ...
    public ResponseEntity<Object> listPostulants_avec_Libelle(@PathVariable String libelle){
        try {
            return Message.Response("", HttpStatus.OK,service.list_postulant_avec_libele(libelle));
    ...
    public ResponseEntity<Object> list_postulant_tirer_avec_libele_de_la_liste(@PathVariable String libelle_liste){
        try {
            return Message.Response("", HttpStatus.OK,service.list_postulant_tirer_avec_libele_de_la_liste(libelle_liste));
        }catch (Exception e){
           return Message.Response(e.getMessage(), HttpStatus.OK,null);
        }
    ...
    ResponseEntity<Object> list_postulant_tirer_avec_libele_de_la_liste_et_du_tirage(@PathVariable String libelle_liste, @PathVariable String libelle_tirage){
        try {

            return Message.Response("", HttpStatus.OK,service.list_postulant_tirer_avec_libele_de_la_liste_et_du_tirage(libelle_liste,libelle_tirage));
